          ...
          <tbody>
            ...
            {brokers.map((broker) => (
              ...
              >
                ...
                <td className="px-4 py-4">
                  <p className="font-semibold text-white">{broker.ceoName}</p>
                  <p className="text-xs text-muted">{broker.title}</p>
                </td>
                <td className="px-4 py-4">
                  <span className="rounded-full border border-border px-3 py-1 text-xs font-semibold text-white">
                    {broker.status}
                  </span>
                </td>
